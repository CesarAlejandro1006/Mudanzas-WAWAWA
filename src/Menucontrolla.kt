...
class Menucontrolla {
    ...
    private val employeesControler = EmployeesControler(printer)
    ...
    private fun validateOptions(selectedOption: Int) {
        when (selectedOption) {
            ...
            2 -> {
                employeesControler.registerEmployees()
                println("")
                showMenu()
            }
            ...
            5 -> {
                employeesControler.showEmpleado()
                println("")
                showMenu()
            }
    ...
    private fun selectedClienteandEmpleadoandMudanza() {
        ...
        if (employeesControler.areNotEmpleadoRegistered()) {
        ...
        val empleado = employeesControler.getEmpleadoByIndex(selectedEmpleadoIndex - 1)
